...
namespace YFK
{
    public class mc
    {
        ...
        {
            public double acc;          //ndi   点位运动的加速度。
            public double dec;          //       点位运动的减速度。
            public double velStart;     // 起跳速度
        ...
        [DllImport("gts.dll")]
        public static extern short GT_ZeroPos(short axis,short count=1);
